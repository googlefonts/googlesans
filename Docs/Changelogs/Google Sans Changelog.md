...
* **Release Candidate 2018/11/19**
* [Commit Link](7d3270e689ab9aaa1b201b6f802301802a5cc238)
* Shift to new Vertical Metrics
	* winAscent: 1000
	* Retain original (v1.027) `yMax` and `yMin` values (forced via a force script found here: [/tools](/tools))
...
*  Entirely re-hinted with VTT `v4.10`.
	*  De-composed `r_t` ligature due to hinting issue
	*  Hinting of ligatures and `cap` numbers have been assigned CVT values ensuring consistent x-height/cap alignment.
*  Last actual-release: `v1.028`
...
* **Android (GMSCore) distribtuion version**
* [Commit Link](5d49d210bfaa6aa15a8c84bef1a7791005e78f34)
* Updated `lcaron` metrics
* Returned vertical metrics to `v1.027`
